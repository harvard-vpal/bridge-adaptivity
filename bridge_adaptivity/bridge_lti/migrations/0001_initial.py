    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lti_content_sources', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bridge_lti.LtiLmsPlatforms')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lms_lti_connection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='bridge_lti.LtiLmsPlatforms')),
            ],
            options={
