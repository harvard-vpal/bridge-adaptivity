...
from .models import BridgeUser, LtiContentSources, LtiLmsPlatforms, LtiUser, OutcomeService
...
class GroupForm(ModelForm):
    ...
    group_source = ModelMultipleChoiceField(
        ...
        queryset=LtiContentSources.objects.all(),
        required=False,
