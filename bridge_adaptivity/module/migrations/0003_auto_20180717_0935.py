...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='slug',
            field=slugger.fields.AutoSlugField(default='default-slug', help_text='Add the slug for the collection. If field empty slug will be created automatically.', populate_from='name', unique=True, verbose_name='slug id'),
